...
export default function Contato() {
  ...
  return (
    <section className="flex flex-col text-center py-26 px-10">
      <h1 className="text-2xl text-(--color-green-500) font-bold pb-1 md:text-4xl lg:text-5xl lg:py-4 xl:text-6xl xl:py-5 2xl:text-7xl 2xl:py-6">
        Contate-nos
      </h1>
      <p className="text-[16px] text-(--color-green-500) pb-5 md:text-2xl md:px-14 lg:text-3xl lg:px-26 lg:mb-1 xl:px-32 2xl:text-4xl 2xl:px-70">
        Precisa de ajuda, encontrou algum problema no site, ou ficou com alguma
        dúvida?
      </p>
      <div className="bg-(--color-tertiary-100) border-1 rounded-[20px] border-(--color-cyan-300) flex flex-col">
        <h2 className="text-(--color-green-500) font-semibold text-[16px] py-1 
        ...
        <div className="md:flex md:flex-row">
          <div className="px-2 flex flex-col md:items-start md:w-[57.5%] md:pl-6 lg:w-[65%] xl:w-[70%] xl:mt-1 2xl:mt-12 2xl:w-full">
            <label className="text-[16px] text-(--color-green-500) font-bold flex py-2 px-1 
            ...
            <input
              ...
              className="border-2 border-(--color-gray-200) rounded-[10px] text-[14px] text-(--color-gray-300) font-medium p-[6px] px-2 
              md:text-[16px] md:w-[80%] xl:p-[10px] 2xl:w-[90%] 2xl:p-[12px] 2xl:text-xl"
            />
            <label className="text-[16px] text-(--color-green-500) font-bold flex py-2 px-1 md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl">
              Email *
            </label>
            <input
              type="text"
            ...
            <div className="flex justify-center py-3 xl:px-34.5 2xl:px-70">
              <button
                ...
                className="w-[80%] border-1 border-(--color-green-400) bg-(--color-green-400) rounded-[15px] text-[18px] text-white flex justify-center gap-3 p-1.5
          ...
          <div
            className="bg-(--color-green-400) rounded-[20px] flex flex-col items-center py-1
                ...
                <li className="flex hover:cursor-default" key={index}>
                  ...
                  >
                    <figure className="flex items-center gap-3 px-3 py-2">
                      <div className="bg-(--color-green-500) hover:cursor-default rounded-[10px] p-3 text-white">
                        {cardsEvolvere.icon}
                      </div>
              ...
              {redesSociais.map((rede, index) => (
                <li className="flex" key={index}>
                  <Link
                    ...
                    title={rede.title}
                  >
                    <div className="bg-(--color-green-500) hover:bg-[#1aa194c4] hover:border-[#1aa194c4] hover:duration-300 rounded-[10px] p-3 text-white">
                      {rede.icon}
                    </div>
                  </Link>
                </li>
      ...
      <section className="flex flex-col items-center text-center p-4">
        <h1 className="text-(--color-green-500) font-bold text-xl lg:text-3xl xl:text-4xl 2xl:text-5xl 2xl:py-1">
          Quer entrar em contato conosco?
        </h1>
        <p className="text-(--color-green-500) text-[16px] pb-5 lg:text-xl xl:text-2xl xl:px-60 2xl:text-3xl 2xl:px-70 2xl:mt-2">
        ...
        <div className="py-1">
          <Link
            ...
            className="w-full border-1 border-(--color-green-400) bg-(--color-green-400) rounded-[15px] text-[18px] text-white flex gap-3 p-1.5 
            hover:bg-[#158277c0] hover:border-[#158277c0] hover:duration-300
        ...
        <h2 className="text-(--color-green-500) font-bold text-xl pb-3 lg:text-2xl xl:text-3xl 2xl:text-4xl">
        ...
        <textarea
          ...
          id="Mensagem"
          placeholder="Digite sua mensagem"
          className="w-full border-1 border-(--color-gray-200) rounded-[10px] p-2 gap-1 text-[14px] 
          sm:w-[70%] sm:h-25 
